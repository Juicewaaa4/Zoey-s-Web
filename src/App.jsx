...
const SERVICES = [
  { icon: '🎱', title: 'Table Rentals', desc: 'Hourly and nightly table rental rates — perfect for casual games or serious practice.' },
...
const GALLERY_ITEMS = [
  {
    name: 'Main Playing Area',
    desc: 'Spacious and well-lit tables for the ultimate experience.',
    image: '/carousel billiards/Billiards.jpg'
  },
  {
    name: 'VIP Section',
    desc: 'Exclusive tables with premium service and privacy.',
  ...
  {
    name: 'Kubo Lounge',
    desc: 'Relaxing traditional kubo with karaoke for groups.',
    image: '/carousel billiards/Kubo.jpg'
  },
  {
    name: 'Kubo Hangout Area',
    desc: 'More space for bonding and chilling with the barkada.',
    image: '/carousel billiards/Kubo1.jpg'
  },
]
  ...
  return (
    <div className="float-2" style={{ pointerEvents: 'none', position: 'absolute', right: 0, top: '50%', transform: 'translateY(-50%)', opacity: 0.18 }} aria-hidden="true">
      <svg width="280" height="280" viewBox="0 0 280 280" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="200" cy="140" r="8" fill={C.primary} />
        <text x="200" y="148" textAnchor="middle" fill="#fff" fontSize="14" fontWeight="bold">8</text>
        ...
        <line x1="30" y1="250" x2="180" y2="100" stroke={C.primaryLight} strokeWidth="4" strokeLinecap="round" />
        <polygon points="25,255 45,245 35,230" fill={C.primary} />
      </svg>
    </div>
  )
}
...
export function BilliardApp({ onSwitchBrand }) {
          ...
          <div className="hero-grid" style={{ position: 'relative', maxWidth: 1280, margin: '0 auto', padding: '0 24px' }}>
            <div style={{ maxWidth: 560 }}>
              <h1 className="reveal" style={{ fontSize: 'clamp(2.2rem, 5vw, 3.5rem)', fontWeight: 800, lineHeight: 1.15, color: C.heading, margin: 0 }}>
                Play, Dine & <span className="text-gradient-animate" style={{ WebkitBackgroundClip: 'text' }}>Chill</span> at <span className="text-gradient-animate" style={{ WebkitBackgroundClip: 'text' }}>Zoey&apos;s</span>
              </h1>
              <p className="reveal reveal-delay-1" style={{ marginTop: 16, fontSize: 18, fontWeight: 600, color: C.primary }}>
                Paltao&apos;s Premier Billiard Experience
              </p>
              <p className="reveal reveal-delay-2" style={{ marginTop: 10, fontSize: 15, color: C.body, lineHeight: 1.7 }}>
                Family-friendly billiards in the heart of Pulilan, Bulacan — est. 2024.
              </p>
              ...
              <div className="reveal reveal-delay-3" style={{ marginTop: 36, display: 'flex', gap: '12px 16px', flexWrap: 'wrap' }}>
                {[
                  ...
                  { icon: '🎱', label: 'Tournament-Grade Tables' },
                  { icon: '🍔', label: 'Snacks & Drinks' },
                ].map((badge) => (
            ...
            <div className="reveal reveal-delay-2 hero-ball-wrapper" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', paddingRight: 24 }}>
              <svg className="hero-ball" width="220" height="220" viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                {/* Ball body — deep forest */}
                <circle cx="110" cy="110" r="105" fill="#064E3B" />
                {/* Shine highlight */}
                <ellipse cx="75" cy="68" rx="28" ry="18" fill="rgba(255,255,255,0.12)" transform="rotate(-30 75 68)" />
                <ellipse cx="68" cy="62" rx="12" ry="7" fill="rgba(255,255,255,0.22)" transform="rotate(-30 68 62)" />
                {/* White circle for number */}
                <circle cx="110" cy="118" r="34" fill="#FFFFFF" />
                {/* Number 8 */}
                <text x="110" y="130" textAnchor="middle" fontSize="38" fontWeight="900" fill="#064E3B" fontFamily="Arial, sans-serif">8</text>
                {/* Subtle rim */}
                <circle cx="110" cy="110" r="105" fill="none" stroke="rgba(255,255,255,0.08)" strokeWidth="3" />
              </svg>
            </div>
          </div>
        </section>
          ...
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 24px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 64, alignItems: 'center' }} className="about-grid">
            <div className="reveal" style={{ display: 'flex', justifyContent: 'center' }}>
              <div className="interactive-logo-wrapper float-1">
                <LogoImage size={280} border={6} />
              </div>
            </div>
            <div className="reveal reveal-delay-1">
              <h2 style={{ fontSize: 'clamp(1.6rem, 3vw, 2.2rem)', fontWeight: 700, color: C.forestDark, margin: '0 0 16px' }}>
                About Zoey&apos;s Billiard House
              </h2>
              <p style={{ fontSize: 15, lineHeight: 1.75, color: C.body, margin: 0 }}>
                Welcome to Zoey&apos;s Billiard House — a family-friendly billiard hall established in 2024
                in Paltao, Pulilan, Bulacan. We&apos;ve built a welcoming space where players of all ages
                can enjoy quality tables, fair rates, and a vibrant community atmosphere right in your neighborhood.
              </p>
          ...
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 24px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 24, maxWidth: 1000, margin: '0 auto' }}>
              ...
              <div className="contact-card reveal reveal-delay-1" style={{ backgroundColor: C.bgWhite, border: `1px solid ${C.cardBorder}`, boxShadow: '0 6px 18px rgba(5,150,105,0.08)' }}>
                ...
                <a href="https://www.facebook.com/profile.php?id=61556625232251" target="_blank" rel="noopener noreferrer"
      ...
      <footer style={{ background: `linear-gradient(135deg, #FFF0F6 0%, #FCE7F3 100%)`, borderTop: `1px solid ${C.primaryPale}`, padding: '32px 0' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 24px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <LogoImage size={44} />
            <span style={{ fontSize: 16, fontWeight: 700, color: C.primary }}>Zoey&apos;s Billiard House</span>
          </div>
          <p style={{ margin: 0, fontSize: 13, color: C.muted, textAlign: 'center' }}>
            © {new Date().getFullYear()} Zoey&apos;s Billiard House · Est. 2024 · Paltao, Pulilan, Bulacan
          </p>
        </div>
      </footer>
...
import EateryApp from './EateryApp'

export default function App() {
  const [activeBrand, setActiveBrand] = useState('billiard')

  useEffect(() => {
    window.scrollTo({ top: 0, behavior: 'auto' })
  }, [activeBrand])

  if (activeBrand === 'eatery') {
    return <EateryApp onSwitchBrand={setActiveBrand} />
  }
  return <BilliardApp onSwitchBrand={setActiveBrand} />
}